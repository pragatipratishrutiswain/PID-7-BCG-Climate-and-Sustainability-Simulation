...
Scope 1 emissions are direct emissions produced from operations controlled or owned by a company (e.g. GHGs created from burning fuel to operate manufacturing plants, furnaces etc.).<br>
Scope 2 emissions are indirect emissions that come from sources purchased by a company in order for it to operate (e.g electricity, or steam). So while a company might not produce electricity, it might rely on buying electricity to power an office or a manufacturing plant.<br>
Scope 3 emissions are indirect emissions produced in a company’s value chain (e.g. emissions generated by delivering, using, and disposing of a product). These activities are not controlled or owned by a company.<br>
